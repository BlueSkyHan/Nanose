<div class='form-group'>
    {!! Form::hidden('price', $productPrice, ['id'=>'so-product-price-input']) !!}
    {!! Form::label('quantity', '数量') !!}
    {!! Form::text('quantity', null, array('placeholder'=>'请输入数量', 'id'=>'so-product-quantity-input', 'class'=>'form-control', 'maxlength'=>'4', 'data-max-quantity'=>$warehouseProductBatchQuantity)) !!}
</div>
...
<script>
    $(function(){
        ...
        $("#so-product-quantity-input").on('input', function(){
