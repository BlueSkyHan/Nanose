<div class="row">
    <div class="col-md-4">
        <div class="form-group" id="provinces">
            ...
            {!! Form::select('province_id', array(''=>'请选择省份') + $provinces, null, array('class'=>'form-control')) !!}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group" id="cities">
            {!! Form::label('city_id', '城市') !!}
            {!! Form::select('city_id', array(''=>'请选择城市'), null, array('class'=>'form-control')) !!}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group" id="districts">
            {!! Form::label('district_id', '区县') !!}
            {!! Form::select('district_id', array(''=>'请选择区县'), null, array('class'=>'form-control')) !!}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-8">
        <div class="form-group">
            ...
            {!! Form::text('line', null, array('placeholder'=>'请输入道路门牌号等相关信息', 'class'=>'form-control non-null-input')) !!}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            {!! Form::label('postcode', '邮政编码') !!}
            {!! Form::text('postcode', null, array('placeholder'=>'请输入邮政编码', 'class'=>'form-control non-null-input')) !!}
        </div>
    </div>
</div>
...
<script>
    $(function(){
        ...
        $(document).on('change', "#provinces select", function(){
            $('#cities').removeClass('has-error').removeClass('has-success');
            ...
            $('#districts').removeClass('has-error').removeClass('has-success');
